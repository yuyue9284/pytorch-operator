...
func NewForConfig(c *rest.Config) (*AzuremlV1Client, error) {
	config := *c
	...
	return &AzuremlV1Client{client}, nil
}

// NewForConfigOrDie creates a new AzuremlV1Client for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *AzuremlV1Client {
...
// New creates a new AzuremlV1Client for the given RESTClient.
func New(c rest.Interface) *AzuremlV1Client {
	return &AzuremlV1Client{c}
}
...
func (c *AzuremlV1Client) RESTClient() rest.Interface {
	if c == nil {
		return nil
	}
	return c.restClient
